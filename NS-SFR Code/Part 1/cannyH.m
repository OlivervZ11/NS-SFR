function [BWh]=cannyH(img, T_Low, T_High)

% CANNY HORIZONTAL is the canny edge detector adapted to give only
% horizontal output.
%
% Input:
%    img:       Image
...
%
% Output:
%    BWh:       Vertical Canny Edge Detection Binary Image
%
